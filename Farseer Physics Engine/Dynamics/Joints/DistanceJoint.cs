...
namespace FarseerPhysics.Dynamics.Joints
{
    ...
    public class DistanceJoint : Joint
    {
		...
		public DistanceJoint(Body bodyA, Body bodyB, float thickness, bool isConnector)
			: base(bodyA, bodyB, thickness)
		{
			JointType = isConnector ? JointType.Connector : JointType.Distance;
