...
namespace FarseerPhysics.Factories
{
    ...
    public static class JointFactory
    {
		...
		#region Connector Joint

		public static DistanceJoint CreateConnector(World world, Body bodyA, Body bodyB, float thickness)
		{
			DistanceJoint distanceJoint = new DistanceJoint(bodyA, bodyB, thickness, true);
